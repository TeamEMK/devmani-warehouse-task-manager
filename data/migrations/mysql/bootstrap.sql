-- Fresh/adhoore database ko poora karne wala bootstrap.
-- backend/start.js ise tab chalata hai jab users table nahi milti.
-- Har statement alag se try hota hai — jo cheez pehle se hai wo skip ho jaati hai.
...
CREATE TABLE IF NOT EXISTS hrm_message_log (
  id int NOT NULL AUTO_INCREMENT,
...
ALTER TABLE delegation_tasks DROP COLUMN client_id;
ALTER TABLE checklist_tasks DROP COLUMN client_id;
...
INSERT IGNORE INTO schema_migrations (filename) VALUES
  ('001_init.sql'),('002_email_case_insensitive.sql'),
  ('003_task_composite_indexes.sql'),('004_drop_unused.sql');

-- Pehla admin (sirf tab banta hai jab ye email maujood na ho)
INSERT IGNORE INTO users (name, email, password, role, department, staff_type)
VALUES ('Admin', 'admin@devmani.com',
'$2a$10$mPv0A34KiFABoPJao0mXE.7eJZZdm7AfeyecGWn16NpUHGAVqmrrO',
